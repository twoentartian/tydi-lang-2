...
impl Project {
    ...
    pub fn parse_package(&mut self, file_path: String, file_content: String) -> Result<(), TydiLangError> {
        let file_package = crate::tydi_lang_src_to_memory_representation::tydi_lang_src_to_memory_representation(file_content)?;
        {
        ...
        self.packages.insert(package_name, file_package);
        return Ok(());
    }
